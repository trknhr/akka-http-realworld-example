...
package object articles {
  ...
  case class ResponseArticle(id: Long,
                             slug: String,
                             title: String,
                             description: String,
                             body: String,
  ...
  case class ArticleUpdated(title: Option[String],
                            description: Option[String],
                            body: Option[String])

  case class ArticlePosted(title: String,
                           description: String,
                           body: String,
                           tagList: Seq[String]) {
  ...
  case class ArticleForResponse(slug: String,
                                title: String,
                                description: String,
                                body: String,
                                tagList: Seq[String],
